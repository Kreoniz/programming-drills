...
- Ran `pnpm_config_verify_deps_before_run=false pnpm drill:check:net`: all 25 networking reference solutions passed.
- Fixed generated `TASK.md` indentation across the pre-networking drill set and added a verifier guard for indented markdown control lines.
